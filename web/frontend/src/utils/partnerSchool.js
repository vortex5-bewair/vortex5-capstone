...
export const PARTNER_SCHOOL = {
  name: 'St. Vincent Blessed School of Manila',
  address: 'Arroceros St., Ermita, Manila',
  established: 1958,
  blurb:
    'St. Vincent Blessed School of Manila is our founding partner — the school where BewAir sensors monitor classroom air quality.',
}
